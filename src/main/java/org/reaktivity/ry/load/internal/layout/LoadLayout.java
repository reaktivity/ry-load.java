 ...
 * under the License.
 */
package org.reaktivity.ry.load.internal.layout;
...
public final class LoadLayout implements AutoCloseable
{
    ...
    public static final class Builder
    {
        ...
        public LoadLayout build()
        {
            ...
            assert metadata.getInt(FIELD_OFFSET_VERSION) == LOAD_VERSION;
            capacity = metadata.getInt(FIELD_OFFSET_BUFFER_LENGTH);
            unmap(metadata);
